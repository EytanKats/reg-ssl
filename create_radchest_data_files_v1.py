...
ROOT_DIR = f'/home/xxxx/storage/staff/yyyyyxxxx/projects/reg_ssl/data/radchest_ct/'
IMAGE_DIR = f'imgs'
MASK_DIR = f'lbls_ts'
PAIRS = f'/home/xxxx/storage/staff/yyyyyxxxx/projects/reg_ssl/data/radchest_ct/list_of_pairs.pth'

OUTPUT_FILE_PATH_TEMPLATE = f'/home/xxxx/storage/staff/yyyyyxxxx/projects/reg_ssl/data/radchest_ct/radchest_ct_5'
